...
`lat/sabellic-loans` — gold tier, anchoring: none. Produced by `nabu data build lat/sabellic-loans` (Nabu 1.6.0); the producer-side contract is docs/nabu-data.md in the Nabu repository.
