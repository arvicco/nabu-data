...
`zho/hani-fold` — gold-derived tier, anchoring: none. Produced by `nabu data build zho/hani-fold` (Nabu 1.6.0); the producer-side contract is docs/nabu-data.md in the Nabu repository.
