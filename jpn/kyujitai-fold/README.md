...
`jpn/kyujitai-fold` — gold tier, anchoring: none. Produced by `nabu data build jpn/kyujitai-fold` (Nabu 1.6.0); the producer-side contract is docs/nabu-data.md in the Nabu repository.
